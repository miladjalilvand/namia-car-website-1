    ...
    <div>
      {isOpen ? (
        <div className="flex">
          ...
          <div onClick={() => changeNav(false)} className="fixed md:w-screen z-20 md:h-screen bg-black opacity-70"></div>
        </div>
      ) : (
        <div className="fixed border-b-2 border-black w-full" style={{ backgroundColor: currentTheme.background }}>
